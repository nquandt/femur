...
public class RouteHandlerEndpointRouteBuilderExtensionsTest
{
    ...
    {
        var ds = GetBuilderEndpointDataSource(endpointRouteBuilder);
        return (RouteEndpointBuilder)ds.GetType().GetMethod("GetSingleRouteEndpointBuilder", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance)!.Invoke(ds, [])!;
    }
    ...
    {
        var builder = new DefaultEndpointRouteBuilder(new ApplicationBuilder(new EmptyServiceProvider()));
        _ = builder.MapEndpoint<EmptyEndpoint>("/", [HttpMethod.Get], i => i.Handle);
        ...
        Assert.Equal("HTTP: GET / => Invoke", routeEndpointBuilder.DisplayName);
    ...
    {
        var builder = new DefaultEndpointRouteBuilder(new ApplicationBuilder(new EmptyServiceProvider()));
        _ = builder.MapEndpoint<EmptyEndpoint>("/", [HttpMethod.Patch], i => i.Handle);
        ...
        var routeEndpointBuilder = GetRouteEndpointBuilder(builder);
        Assert.Equal("HTTP: PATCH / => Invoke", routeEndpointBuilder.DisplayName);
        Assert.Equal("/", routeEndpointBuilder.RoutePattern.RawText);
    }
    ...
    {
        var sp = new ServiceCollection().AddTransient<IdRouteEndpoint>().BuildServiceProvider();
        var builder = new DefaultEndpointRouteBuilder(new ApplicationBuilder(sp));
        _ = builder.MapEndpoint<IdRouteEndpoint>("/{id}", [HttpMethod.Get], i => i.Handle);
        ...
        var routeEndpointBuilder = GetRouteEndpointBuilder(builder);
        Assert.Equal("HTTP: GET /{id} => Invoke", routeEndpointBuilder.DisplayName);
    ...
    public async Task MapGet_WithoutRouteParameter_BuildsEndpointWithQuerySpecificBinding()
    {
        var sp = new ServiceCollection().AddTransient<IdRouteEndpoint>().BuildServiceProvider();
        var builder = new DefaultEndpointRouteBuilder(new ApplicationBuilder(sp));
        _ = builder.MapEndpoint<IdRouteEndpoint>("/", [HttpMethod.Get], i => i.Handle);
    ...
    {
        var builder = new DefaultEndpointRouteBuilder(new ApplicationBuilder(new EmptyServiceProvider()));
        _ = builder.MapEndpoint<TodoEndpoint>("/", [HttpMethod.Get], i => i.Handle);
        var dataSource = GetBuilderEndpointDataSource(builder);
    ...
    {
        var builder = new DefaultEndpointRouteBuilder(new ApplicationBuilder(new EmptyServiceProvider()));
        _ = builder.MapEndpoint<TodoEndpoint>("/", [HttpMethod.Delete], i => i.Handle);
        var dataSource = GetBuilderEndpointDataSource(builder);
        var ex = Assert.Throws<InvalidOperationException>(() => dataSource.Endpoints);
        Assert.Contains("Body was inferred but the method does not allow inferred body parameters.", ex.Message);
        Assert.Contains("Did you mean to register the \"Body (Inferred)\" parameter(s) as a Service or apply the [FromServices] or [FromBody] attribute?", ex.Message);
    ...
    public void MapVerb_ThrowsWithImplicitFromBody(HttpMethod method)
    {
        var builder = new DefaultEndpointRouteBuilder(new ApplicationBuilder(new EmptyServiceProvider()));
        _ = builder.MapEndpoint<TodoEndpoint>("/", [method], i => i.Handle);
        var dataSource = GetBuilderEndpointDataSource(builder);
        var ex = Assert.Throws<InvalidOperationException>(() => dataSource.Endpoints);
        Assert.Contains("Body was inferred but the method does not allow inferred body parameters.", ex.Message);
        Assert.Contains("Did you mean to register the \"Body (Inferred)\" parameter(s) as a Service or apply the [FromServices] or [FromBody] attribute?", ex.Message);
    ...
    public void MapGet_ImplicitFromService()
    {
        ...
        _ = builder.MapEndpoint<TodoServiceEndpoint>("/", [HttpMethod.Get], i => i.Handle);
    ...
    {
        var builder = new DefaultEndpointRouteBuilder(new ApplicationBuilder(new ServiceCollection().AddSingleton<TodoService>().BuildServiceProvider()));
        _ = builder.MapEndpoint<TodoServiceEndpoint>("/", [HttpMethod.Delete], i => i.Handle);
        ...
        var routeEndpointBuilder = GetRouteEndpointBuilder(builder);
        Assert.Equal("HTTP: DELETE / => Invoke", routeEndpointBuilder.DisplayName);
        Assert.Equal("/", routeEndpointBuilder.RoutePattern.RawText);
    }
    ...
    {
        var builder = new DefaultEndpointRouteBuilder(new ApplicationBuilder(new ServiceCollection().AddSingleton<TodoService>().BuildServiceProvider()));
        _ = builder.MapEndpoint<TodoServiceEndpoint>("/", [HttpMethod.Patch], i => i.Handle);
    ...
    {
        var builder = new DefaultEndpointRouteBuilder(new ApplicationBuilder(new ServiceCollection().AddSingleton<TodoService>().BuildServiceProvider()));
        _ = builder.MapEndpoint<TodoEndpointWithAttribute>("/", [HttpMethod.Get], i => i.Handle);
    ...
    {
        var builder = new DefaultEndpointRouteBuilder(new ApplicationBuilder(new ServiceCollection().AddSingleton<TodoService>().BuildServiceProvider()));
        _ = builder.MapEndpoint<TodoEndpointWithAttribute>("/", [HttpMethod.Delete], i => i.Handle);
    ...
    {
        var builder = new DefaultEndpointRouteBuilder(new ApplicationBuilder(new ServiceCollection().AddSingleton<TodoService>().BuildServiceProvider()));
        _ = builder.MapEndpoint<TodoEndpointWithAttribute>("/", [HttpMethod.Patch], i => i.Handle);
    ...
    public class IdRouteEndpoint
    {
        public void Handle(int? id, HttpContext httpContext)
        {
            if (id is not null)
            {
                httpContext.Items["input"] = id;
